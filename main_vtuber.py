...
def extract_PSE_feats():
    ...
    # why does it have to be csv?
    # directly feeding bbox information from opencv face detection module to this dictionary
    print(data_dict)
    print(len(data_dict))
    # basically targetting one person, hence should be one.
